	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
			...
			case 'stage':
				{
					defaultCamZoom = 0.55;
					curStage = 'stage';
					var bg:FlxSprite = new FlxSprite(-800, -1350).loadGraphic(Paths.image('fuck_krite'));
					bg.antialiasing = true;
			...
			default:
			{
					defaultCamZoom = 0.9;
					curStage = 'stage';
					var bg:FlxSprite = new FlxSprite(-300, -200).loadGraphic(Paths.image('fuck_krite'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.scale.set(.8, .8);
					bg.active = false;
		...
		switch (SONG.player2)
		{
			...
			case 'one': 
				dad.y += 370;
				camPos.set(dad.getGraphicMidpoint().x + 300, dad.getGraphicMidpoint().y-930);
		}
